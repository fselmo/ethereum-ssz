...
class TestBitvector:
    ...
    def test_bitvector_TTFTFTFF(self):
        ...
        bv = Bitvector(bits=[1, 1, 0, 1, 0, 1, 0, 0], length=8)
    ...
    def test_bitvector_FTFT(self):
        ...
        bv = Bitvector(bits=[0, 1, 0, 1], length=4)
    ...
    def test_bitvector_FTF(self):
        ...
        bv = Bitvector(bits=[0, 1, 0], length=3)
    ...
    def test_bitvector_TFTFFFTTFT(self):
        ...
        # Result: 0xc502
        bv = Bitvector(bits=[1, 0, 1, 0, 0, 0, 1, 1, 0, 1], length=10)
    ...
    def test_bitvector_TFTFFFTTFTFFFFTT(self):
        ...
        bv = Bitvector(
            bits=[1, 0, 1, 0, 0, 0, 1, 1, 0, 1, 0, 0, 0, 0, 1, 1], length=16
        )
...
class TestBitlist:
    ...
    def test_bitlist_TTFTFTFF(self):
        ...
        bl = Bitlist(bits=[1, 1, 0, 1, 0, 1, 0, 0], max_length=8)
    ...
    def test_bitlist_FTFT(self):
        ...
        bl = Bitlist(bits=[0, 1, 0, 1], max_length=4)
    ...
    def test_bitlist_FTF(self):
        ...
        bl = Bitlist(bits=[0, 1, 0], max_length=3)
    ...
    def test_bitlist_TFTFFFTTFT(self):
        ...
        bl = Bitlist(bits=[1, 0, 1, 0, 0, 0, 1, 1, 0, 1], max_length=16)
